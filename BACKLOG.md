...
- [ ] Run integration passes for all supported concepts — per-concept, two-phase model. Dedicated session note at `Q3_INTEGRATION_SESSIONS.md` (scope: all papers published before Q4 2025, across all 23 concepts). **`flow-matching`, `speech-to-speech`, `rlhf-speech`, `evaluation-metrics`, `disentanglement`, `autoregressive-codec-tts`, `instruction-conditioned-tts`, `prosody-control`, `zero-shot-tts`, `diffusion-tts`, and `subjective-evaluation` are fully closed** (Phase 1 + Phase 2): 97/97, 60/63, 29/29, 285/286, 100/100, 165/165, 44/44, 94/94, 203/203, 46/46, and 180/180 Q3-scoped papers respectively (the 3-paper gap on speech-to-speech and the 1-paper gap on evaluation-metrics are intentional exclusions). `subjective-evaluation` closed on 2026-07-27 after nine Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 771 Phase 1 claims; 133/180 papers have reciprocal architecture-family assignments and 47 architecture-unspecified evaluation, benchmark, dataset, or metric outliers remain. `diffusion-tts` closed on 2026-07-26 after three Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 15 claim_clusters from 199 Phase 1 claims; 41/46 papers have reciprocal family assignments and 5 architecture-unspecified or diffusion-adjacent outliers remain. `zero-shot-tts` closed on 2026-07-26 after eleven Phase 1 batches and one Phase 2 synthesis pass, with 9 method_families and 18 claim_clusters from 903 Phase 1 claims; 187/203 papers have reciprocal family assignments and 16 infrastructure, evaluation, historical-context, or architecture-unspecified outliers remain. `prosody-control` closed on 2026-07-25 with 14 method_families and 17 claim_clusters from 404 Phase 1 claims; 82/94 papers have reciprocal family assignments and 12 low-relevance/contextual outliers remain. `instruction-conditioned-tts` closed the same day with 8 method_families and 15 claim_clusters. `autoregressive-codec-tts` closed with 13 method_families and 17 claim_clusters. `evaluation-metrics` remains the largest closed concept (285 papers); `zero-shot-tts` is second (203), followed by `subjective-evaluation` (180). 12 other concepts have not started — no `_claims/` YAML exists for them yet. Corpus-wide `papers_not_in_any_yaml`: 106 as of 2026-07-27.
