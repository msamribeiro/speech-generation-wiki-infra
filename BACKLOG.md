...
- [ ] Run integration passes for all supported concepts — per-concept, two-phase model. Dedicated session note bootstrapped 2026-07-18 at `Q3_INTEGRATION_SESSIONS.md` (scope: all papers published before Q4 2025, across all 23 concepts). **flow-matching in progress**: 34/112 candidate papers integrated (round 1 complete 2026-07-15, committed and pushed); 22 other concepts have not started — no `_claims/` YAML exists for them yet. Corpus-wide `papers_not_in_any_yaml` (Q3-and-earlier scope): 463 as of 2026-07-18
