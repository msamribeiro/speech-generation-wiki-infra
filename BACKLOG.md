...
- [ ] Run integration passes for all supported concepts — per-concept, two-phase model. Dedicated session note at `Q3_INTEGRATION_SESSIONS.md` (scope: all papers published before Q4 2025, across all 23 concepts). **`flow-matching`, `speech-to-speech`, `rlhf-speech`, `evaluation-metrics`, `disentanglement`, `autoregressive-codec-tts`, `instruction-conditioned-tts`, `prosody-control`, `zero-shot-tts`, `diffusion-tts`, `subjective-evaluation`, `spoken-language-model`, `neural-codec`, `voice-conversion`, `self-supervised-speech`, `speaker-adaptation`, `multilingual-tts`, `emotion-synthesis`, `gan-vocoder`, `streaming-tts`, and `transformer-enc-dec-tts` are fully closed** (Phase 1 + Phase 2): 97/97, 60/63, 29/29, 285/286, 100/100, 165/165, 44/44, 94/94, 203/203, 46/46, 180/180, 127/127, 183/183, 87/87, 146/146, 79/79, 75/75, 73/73, 60/60, 54/54, and 28/28 Q3-scoped papers respectively (the 3-paper gap on speech-to-speech and the 1-paper gap on evaluation-metrics are intentional exclusions). `multilingual-tts` closed on 2026-07-29 after four Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 325 Phase 1 claims; 67/75 papers have reciprocal architecture-family assignments and 8 architecture-unspecified evaluation, corpus, or peripheral-task outliers remain. `emotion-synthesis` closed on 2026-07-30 after four Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 324 Phase 1 claims; 62/73 papers have reciprocal architecture-family assignments and 11 architecture-unspecified evaluation, benchmark, or system-level outliers remain. `gan-vocoder` closed on 2026-07-30 after three Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 259 Phase 1 claims; all 60 papers have reciprocal architecture-family assignments with 98 memberships. `streaming-tts` closed on 2026-07-30 after three Phase 1 batches and one Phase 2 synthesis pass, with 5 method_families and 17 claim_clusters from 247 Phase 1 claims; 51/54 papers have reciprocal architecture-family assignments and 3 architecture-unspecified evaluation or system-level outliers remain. `transformer-enc-dec-tts` closed on 2026-07-30 after two Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 119 Phase 1 claims; 27/28 papers have reciprocal architecture-family assignments and one architecture-unspecified evaluation outlier remains. `speaker-adaptation` closed on 2026-07-29 after four Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 336 Phase 1 claims; 70/79 papers have reciprocal architecture-family assignments and 9 architecture-unspecified corpus, evaluation, assistive, or peripheral-task outliers remain. `self-supervised-speech` closed on 2026-07-29 after eight Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 644 Phase 1 claims; 127/146 papers have reciprocal architecture-family assignments and 19 architecture-unspecified survey, evaluation, dialogue, codec, or peripheral-system outliers remain. `voice-conversion` closed on 2026-07-28 after five Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 372 Phase 1 claims; 78/87 papers have reciprocal architecture-family assignments and 9 architecture-unspecified survey, evaluation, privacy, or peripheral-system outliers remain. `neural-codec` closed on 2026-07-28 after ten Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 832 Phase 1 claims; 171/183 papers have reciprocal architecture-family assignments and 12 architecture-unspecified survey, evaluation, or peripheral-generation outliers remain. `spoken-language-model` closed on 2026-07-27 after seven Phase 1 batches and one Phase 2 synthesis pass, with 6 method_families and 17 claim_clusters from 571 Phase 1 claims; 99/127 papers have reciprocal architecture-family assignments and 28 architecture-unspecified survey, benchmark, dataset, or evaluation outliers remain. `subjective-evaluation` closed on 2026-07-27 after nine Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 17 claim_clusters from 771 Phase 1 claims; 133/180 papers have reciprocal architecture-family assignments and 47 architecture-unspecified evaluation, benchmark, dataset, or metric outliers remain. `diffusion-tts` closed on 2026-07-26 after three Phase 1 batches and one Phase 2 synthesis pass, with 7 method_families and 15 claim_clusters from 199 Phase 1 claims; 41/46 papers have reciprocal family assignments and 5 architecture-unspecified or diffusion-adjacent outliers remain. `zero-shot-tts` closed on 2026-07-26 after eleven Phase 1 batches and one Phase 2 synthesis pass, with 9 method_families and 18 claim_clusters from 903 Phase 1 claims; 187/203 papers have reciprocal family assignments and 16 infrastructure, evaluation, historical-context, or architecture-unspecified outliers remain. `prosody-control` closed on 2026-07-25 with 14 method_families and 17 claim_clusters from 404 Phase 1 claims; 82/94 papers have reciprocal family assignments and 12 low-relevance/contextual outliers remain. `instruction-conditioned-tts` closed the same day with 8 method_families and 15 claim_clusters. `autoregressive-codec-tts` closed with 13 method_families and 17 claim_clusters. `evaluation-metrics` remains the largest closed concept (285 papers); `zero-shot-tts` is second (203), followed by `neural-codec` (183) and `subjective-evaluation` (180). Two other concepts have not started — no `_claims/` YAML exists for them yet. Corpus-wide `papers_not_in_any_yaml`: 142 as of 2026-07-30.
- [ ] Design and implement a recurring cross-concept claim-cluster reconciliation pass — **start after Q3 2025 integration is complete**, then run after each quarterly integration cycle or other large integration round. Per-concept YAMLs should retain concept-specific claims, evidence, status, confidence, and caveats, but semantically overlapping clusters need explicit relationships so renderers and field-level synthesis do not present them as independent discoveries. Scope:
  - Define a cross-concept relationship schema, including at least a canonical or `broader_claim` reference and, if needed, `related_claims` for overlaps that should not be merged.
  - Define when clusters should remain concept-local, link to a broader canonical proposition, or be merged; do not force claims together when their evidence thresholds, polarity, or scope differ by concept.
  - Build a corpus-wide audit that compares cluster meaning across all `_claims/*.yaml` files and emits review candidates for semantic duplicates or near-duplicates; automated similarity should flag candidates, not mutate claim graphs without review.
  - Extend the integration health suite to validate cross-concept references, detect broken links and cycles, and report unresolved high-similarity candidates. Existing validation only detects duplicate cluster IDs within one concept YAML.
  - Update render and field-synthesis behavior to follow canonical/broader relationships and avoid double-counting linked clusters while preserving concept-specific presentation.
  - Record each reconciliation run in `wiki/log.md`, including concepts and clusters reviewed, links or merges accepted, candidates deferred, and the triggering quarter or integration round.
...
- [x] Prototype and implement two concept rendering depths from each claims YAML: **Overview** for rapid cross-concept state-of-the-art scanning and **In Depth** for detailed reader-oriented analysis. The YAML remains the exhaustive machine-readable layer; Markdown does not reproduce full claim graphs. Prototyped and promoted `speech-to-speech`, `evaluation-metrics`, `flow-matching`, and `rlhf-speech`; migrated the production catalog and render contract. Design: `docs/design/concept-rendering.md` *(completed 2026-07-24)*
...
- [x] Build render module (`scripts/checks/render.py`): validates Overview and In Depth frontmatter, required sections, reciprocal links, YAML paper count and digest date, generation provenance, citation membership, catalog entries, and target lengths; missing renders remain warnings so newly integrated concepts can await rendering; legacy evidence dossiers are not required *(completed 2026-07-24)*
