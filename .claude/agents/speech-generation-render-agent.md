...
11. Every concept rendered this run must have its `wiki/concepts/index.md` row updated to match (Papers count from YAML `paper_count`, Evidence link only if a dossier exists, Last updated set to today).
