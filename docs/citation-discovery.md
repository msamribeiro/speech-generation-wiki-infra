...
**The corpus has structural biases.** The index aggregates citations from all parsed papers — ingested or not — so parse coverage is complete. The limitation is at the fetch level: we cover arXiv cs.SD/eess.AS/cs.CL, Interspeech 2025, ACL/EMNLP/NAACL 2025, ICLR and NeurIPS 2025–2026. We have no coverage of ICASSP, ASRU, SLT, older Interspeech years, or ICML. Papers from those venues never appear as *citors* in our corpus, which means their citation behaviour doesn't influence the counts. A paper that is primarily influential in the ICASSP community but rarely cited in the arXiv/Interspeech/NLP circuit will be underrepresented regardless of real-world influence. Similarly, the coverage window (2025–2026) means older foundational papers naturally accumulate high counts — they've had more time and more corpus papers to be cited by — while very recent papers are structurally undercounted relative to their eventual influence.
