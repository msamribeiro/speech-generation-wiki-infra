...
**The index reflects a bounded slice of the literature, not the field universally.** Parse coverage is complete for all fetched papers — the limitation is at the fetch level. We cover arXiv cs.SD/eess.AS/cs.CL, Interspeech 2025, ACL/EMNLP/NAACL 2025, ICLR and NeurIPS 2025–2026, with consistent venue coverage across the July 2025–May 2026 window. Papers from ICASSP, ASRU, SLT, ICML, and older conference years never appear as citors, so their citation behaviour doesn't influence the counts.

This bounded scope is a constraint on generalisability, but it also makes the index useful in a way that a universal citation count would not be. The question it answers precisely is: *within this slice of the TTS/VC/SCA literature, during this period, which papers was the community most consistently building on?* That's a well-defined and answerable question. A paper with 196 citations in our index was cited in roughly 22% of all corpus papers published between July 2025 and May 2026 — a concrete statement about the field during that window.

Because venue coverage is consistent across the window, the index also supports trend analysis across time slices. Rebuilding the index quarterly and comparing the top-cited lists would show whether foundational papers like VALL-E and HiFi-GAN are holding their position or being displaced by newer work, whether evaluation papers are being cited more or less as the field matures, and which new papers are rising fastest in community uptake. That kind of longitudinal view — "top 100 cited papers, TTS/VC literature, 2025 H2 vs 2026 H1" — is exactly what a corpus with consistent fetch methodology enables.
