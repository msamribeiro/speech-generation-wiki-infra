...
Archived: 2026-08-02 (moved from infra root `Q4_INGESTION_SESSIONS.md`)
Superseded by: `Q1_INGESTION_SESSIONS.md` (infra root) — the active ingest protocol and cadence
...
of the Q4 2025 chronological ingest effort, including every QC issue caught and how it was
resolved. For the current ingestion protocol, quality-check procedure, and cadence preferences,
see `Q1_INGESTION_SESSIONS.md` or `docs/content.md`.
